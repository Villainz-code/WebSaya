          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/WebSaya/views/pert2.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 2</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/WebSaya/views/pert3.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 3</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/WebSaya/views/pert4.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 4</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/WebSaya/views/pert5.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 5</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/WebSaya/views/pert6.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 6</p>
                    </a>
                  </li>
